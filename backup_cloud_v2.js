...
const sa = JSON.parse(fs.readFileSync('C:/Users/khelw/Downloads/CRM/marts-crm-v2-firebase-adminsdk-fbsvc-f6203497be.json', 'utf8'));
const PROJECT_ID = 'marts-crm-v2';
